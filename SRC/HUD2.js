...
function preload_hud2(s) {
    ...
    img_bottonemenu_2 = PP.assets.image.load(s, "ASSETS/IMAGES/bottonemenu.png");
...
function create_hud2(s) {
    ...
    text_score_2 = PP.shapes.text_styled_add(s, 10, 20, "0", 40, "Fatfrank", "normal", "0xb86127", null, 0, 0);
    text_menu_2 = PP.shapes.text_styled_add(s, 1188, 73, "Esc", 20, "Fatfrank", "normal", "0xb86127", null, 0, 0);
    ...
    text_menu_2.tile_geometry.scroll_factor_x = 0;
    text_menu_2.tile_geometry.scroll_factor_y = 0;
    ...
    bottonemenu_2.tile_geometry.scroll_factor_x = 0;
