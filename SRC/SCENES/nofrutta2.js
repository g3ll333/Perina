...
function preload(s) {
    img_sfondo = PP.assets.image.load(s, "ASSETS/IMAGES/nofrutta2.png");
    yesbutton = PP.assets.image.load(s, "ASSETS/IMAGES/playagain2.png");
    homebutton = PP.assets.image.load(s, "ASSETS/IMAGES/homebutton1.png");
}
...
PP.scenes.add("nofrutta2", preload, create, update, destroy);