...
function preload(s) {
    img_sfondo = PP.assets.image.load(s, "ASSETS/IMAGES/level2.png");
    yesbutton = PP.assets.image.load(s, "ASSETS/IMAGES/play2.png");
    homebutton = PP.assets.image.load(s, "ASSETS/IMAGES/homevincita2.png");
}
...
function create(s) {
    ...
    let buttonyes = PP.assets.image.add(s, yesbutton, 635, 460, 0.5, 0.5);
...
PP.scenes.add("iniziolev2", preload, create, update, destroy);
