...
function preload(s) {
    img_sfondo = PP.assets.image.load(s, "ASSETS/IMAGES/nofrutta3.png");
    yesbutton = PP.assets.image.load(s, "ASSETS/IMAGES/playagain3.png");
    homebutton = PP.assets.image.load(s, "ASSETS/IMAGES/homebutton2.png");
}
...
function create(s) {
    ...
    let buttonyes = PP.assets.image.add(s, yesbutton, 640, 560, 0.5, 0.5);
...
PP.scenes.add("nofrutta3", preload, create, update, destroy);